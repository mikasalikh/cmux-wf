...
Воркфло-пакет для оркестрации многоагентских рабочих процессов [Claude Code](https://claude.ai) внутри [cmux](https://cmux.com) — мультиплексора терминалов с поддержкой статусов, логов, уведомлений и управления workspace. Особенно полезен при работе над большими проектами, где задачи можно распараллелить между несколькими агентами.
